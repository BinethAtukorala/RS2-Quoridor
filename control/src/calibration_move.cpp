...
int main(int argc, char * argv[])
{
    ...
    // std::vector<std::vector<double>> waypoints = {
    //     toRadians({-51.71, -77.21, -57.57, -132.27, 88.43, 47.16}),
    //     toRadians({-67.23, -82.90, -66.70, -124.73, 92.55, 27.23}),
    //     toRadians({-149.04, -106.06, -64.80, -124.96, 122.64, 267.68}),
    //     toRadians({-169.47, -112.07, -63.04, -122.01, 118.40, 262.45}),
    //     // toRadians({13.32, -141.53, -43.77, -145.08, 68.72, 135.55}),
    //     toRadians({5.15, -118.24, -43.78, -146.88, 69.67, 152.21}),
    //     toRadians({0, -90, 0, -90, 0, 0}),
    //     // toRadians({13.32, -141.53, -43.77, -145.08, 68.72, 135.55}),
    //     // toRadians({-21.19, -104.06, -44.06, -140.26, 80.28, 69.90}),
    //     toRadians({2.12, -137.95, -1.93, -171.61, 79.04, 62.98}),
    //     toRadians({-65.50, -71.93, -79.91, -117.71, 100.82, 44.27}),
    //     toRadians({-130.91, -115.49, -47.46, -134.52, 122.94, 341.55}),
    //     toRadians({-153.98, -133.57, -26.99, -150.92, 117.23, 328.10}),
    //     toRadians({1.41, -122.57, -53.17, -142.15, 78.92, 85.11}),
    //     toRadians({-61.06, -128.71, -7.91, -154.12, 93.08, 26.51}),
    //     toRadians({-96.78, -130.48, -4.82, -157.74, 112.64, 12.02}),
    //     toRadians({-44.04, -133.01, 8.49, -167.27, 85.40, 16.76}),
    //     toRadians({-90.29, -30.27, -93.90, -122.45, 105.13, 48.85}),
    //     toRadians({-118.09, -120.95, -29.98, -142.84, 114.54, 15.19}),
    //     toRadians({-25.53, -114.77, -18.44, -158.34, 81.86, 36.20}),
    //     toRadians({-125.10, -71.30, -128.24, -57.48, 118.95, 284.37}),
    //     toRadians({-7.66, -82.62, -91.64, -128.83, 75.47, 56.78}),
    //     toRadians({-52.52, -92.71, 1.43, -173.62, 84.10, 15.67})
    // };

    std::vector<std::vector<double>> waypoints = {
        {-1.14323,-1.5367,-0.890362,-2.31054,1.59193,0.41019},
        {-2.34351,-1.59169,-0.721605,-2.35487,2.09784,-1.14305},
        {-2.51304,-1.32914,-1.26122,-2.12002,1.93931,-0.516839},
        {-0.306122,-1.8506,-0.891538,-2.4719,1.52408,2.12025},
        {0.0333672,-2.05587,-0.891694,-2.33616,1.2689,2.71898},
        {-1.20631,-1.04327,-1.68164,-1.92399,1.66004,0.351361},
        {-2.63095,-1.90528,-1.27904,-1.53477,2.25916,-1.54198},
        {-2.49845,-2.10972,-0.751138,-2.41242,2.0131,-0.449098},
        {-0.146113,-1.80916,-0.422776,-2.74596,1.18629,2.61117},
        {-0.134398,-1.52194,-0.906685,-2.53168,1.46482,2.04288},
        {-1.11444,-0.914705,-1.19465,-2.31674,1.46571,0.167966},
        {-1.1142,-0.966466,-0.698325,-2.62133,1.47253,0.206938},
        {-1.05854,-2.0858,-0.203575,-2.75352,1.70971,0.509889},
        {-2.34496,-1.7399,-1.12173,-2.03942,2.096,-0.608795},
        {-0.505976,-0.84225,-1.10443,-2.55771,1.40597,0.942343},
        {-1.94966,-1.84452,-0.583032,-2.51673,1.99722,-0.0104411},
        {-1.49664,-2.22572,-0.423006,-2.58987,1.83196,0.104959},
        {-1.18704,-2.3132,-0.25013,-2.65252,1.61452,0.171088},
        {-2.06572,-2.43794,-0.583048,-2.39885,2.02604,-0.5963},
        {-0.801558,-1.79465,-0.955127,-2.41441,1.43627,0.482151}
    };
